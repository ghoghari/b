...
function RoleEdit() {
    ...
    const loadUser = async () => {
        roleService.getRole(id, roleData).then((res) => {
    ...
    return (
        <>
            <div className="content-wrapper">
                <Heading mainTitle={"Roles"} url='/roles' innerPage={true} pageTitle={title} />
